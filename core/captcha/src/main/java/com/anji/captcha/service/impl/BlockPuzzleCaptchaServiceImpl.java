...
public class BlockPuzzleCaptchaServiceImpl extends AbstractCaptchaservice {
    ...
    public ResponseModel get(CaptchaVO captchaVO) {
        ...
        CaptchaVO captcha = pictureTemplatesCut(originalImage, jigsawImage, captchaVO.getRandomKey());
        if (captcha == null
     ...
     * 根据模板切图
     */
    public CaptchaVO pictureTemplatesCut(BufferedImage originalImage, BufferedImage jigsawImage, boolean randomKey) {
        try {
            ...
            //随机生成拼图坐标
            PointVO point = generateJigsawPoint(originalWidth, originalHeight, jigsawWidth, jigsawHeight, randomKey);
            int x = point.getX();
            int y = point.getY();
...
//            base64StrToImage(encoder.encodeToString(jigsawImages), "D:\\滑动.png");
     ...
     * @return
     */
    private PointVO generateJigsawPoint(int originalWidth, int originalHeight, int jigsawWidth, int jigsawHeight, boolean randomKey) {
        ...
        String key = randomKey ? AESUtil.getKey() : aseKey;
